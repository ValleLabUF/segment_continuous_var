...
output: 
  flexdashboard::flex_dashboard:
    ...
    social: menu
    source_code: https://github.com/joshcullen/segment_continuous_var
    theme: journal
---
...
observe({
  ...
  #set palette
  pal1<- colorNumeric(palette = "viridis", domain = dat.filt()$tseg)
  ...
  df<- reactive({
    ...
    # }
    # 
    # df<- bind_rows(dat.store)
    # df<- rbind(df, df[df$tseg == max(df$tseg),])
